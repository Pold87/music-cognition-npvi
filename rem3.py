...
s_bach = m21.corpus.parse('bach/bwv121.6')
...
changer_s_bach = changer.nPVI_changer(s_bach)

# Get a 15s piece of the melody of the original song
changer_s_bach.old_song.show()
...
changer_s_bach_copied.new_song.show()
...
changer_s_bach.find_by_permutation(goal = 45, eps=3, n=100000)
print("nPVI is: ", changer_s_bach.get_new_nPVI())
changer_s_bach.new_song.show()
...
changer2 = changer.nPVI_changer(s_bach)
