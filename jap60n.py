...
output = "/home/pold/npvi/jap60nonmetrical.mid"
...
song_changer = changer.nPVI_changer(song, tmp_midi_file="/home/pold/npvi/tmjapphjhka.mid")

# Find highest nPVI by intercepting note durations (short - long, short - long)

# song_changer.add_gaussian_noise(sd = 0.01)

song_changer.find_by_permutation(60, 3, min_sd=0.027)
