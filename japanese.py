...
output = "/home/pold/npvi/jap20nonmetrical2.mid"
...
song_changer = changer.nPVI_changer(song, tmp_midi_file="/home/pold/npvi/tmjasdappa.mid")

# Find highest nPVI by intercepting note durations (short - long, short - long)

# song_changer.add_gaussian_noise(sd = 0.01)

song_changer.find_incrementally_from_lowest(20, 3, min_sd=0.025)
